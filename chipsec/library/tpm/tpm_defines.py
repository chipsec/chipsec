...
RESPONSE_CODE = {
    ...
    0x181: ['TPM_RC_ASYMMETRIC', 'Asymmetric algorithm not supported or incorrect.'],
    0x182: ['TPM_RC_ATTRIBUTES', 'Inconsistent attributes.'],
    0x183: ['TPM_RC_HASH', 'Unsupported or inappropriate hash algorithm.'],
    0x184: ['TPM_RC_VALUE', 'Value out of range or not correct for context.'],
    0x185: ['TPM_RC_HIERARCHY', 'Hierarchy is not enabled or incorrect for use.'],
    0x187: ['TPM_RC_KEY_SIZE', 'Key size not supported.'],
    0x188: ['TPM_RC_MGF', 'Mask generation function not supported.'],
    0x189: ['TPM_RC_MODE', 'Mode of operation not supported.'],
    0x18A: ['TPM_RC_TYPE', 'Value type is not appropriate.'],
    0x18B: ['TPM_RC_HANDLE', 'Handle not correct for use.'],
    0x18C: ['TPM_RC_KDF', 'Unsupported or inappropriate key derivation function.'],
    0x18D: ['TPM_RC_RANGE', 'Value out of allowed range.'],
    0x18E: ['TPM_RC_AUTH_FAIL', 'Authorization HMAC check failed or DA counter incremented.'],
    0x18F: ['TPM_RC_NONCE', 'Invalid nonce size or nonce value mismatch.'],
    0x190: ['TPM_RC_PP', 'Authorization requires assertion of PP.'],
    0x192: ['TPM_RC_SCHEME', 'Unsupported or incompatible scheme.'],
    0x195: ['TPM_RC_SIZE', 'Structure is the wrong size.'],
    0x196: ['TPM_RC_SYMMETRIC', 'Unsupported symmetric algorithm or key size.'],
    0x197: ['TPM_RC_TAG', 'Incorrect structure tag.'],
    0x198: ['TPM_RC_SELECTOR', 'Union selector is incorrect.'],
    0x19A: ['TPM_RC_INSUFFICIENT', 'TPM unable to unmarshal due to insufficient octets in buffer.'],
    0x19B: ['TPM_RC_SIGNATURE', 'Signature is invalid.'],
    0x19C: ['TPM_RC_KEY', 'Key fields not compatible with selected use.'],
    0x19D: ['TPM_RC_POLICY_FAIL', 'Policy check failed.'],
    0x19F: ['TPM_RC_INTEGRITY', 'Integrity check failed.'],
    0x1A0: ['TPM_RC_TICKET', 'Invalid ticket.'],
    0x1A1: ['TPM_RC_RESERVED_BITS', 'Reserved bits not set to zero as required.'],
    0x1A2: ['TPM_RC_BAD_AUTH', 'Authorization failure without DA implications.'],
    0x1A3: ['TPM_RC_EXPIRED', 'The policy has expired.'],
    0x1A4: ['TPM_RC_POLICY_CC', 'The commandCode in the policy is not the commandCode of the command.'],
    0x1A5: ['TPM_RC_BINDING', 'Public and sensitive portions of an object are not cryptographically bound.'],
    0x1A6: ['TPM_RC_CURVE', 'Curve not supported.'],
    0x1A7: ['TPM_RC_ECC_POINT', 'Point is not on the required curve.'],
    0x1A8: ['TPM_RC_FW_LIMITED', 'The hierarchy is firmware-limited but the Firmware Secret is unavailable.'],
    0x1A9: ['TPM_RC_SVN_LIMITED', 'The hierarchy is SVN-limited but the Firmware SVN Secret associated with the given SVN is unavailable.'],
    0x1AA: ['TPM_RC_CHANNEL', 'Command requires secure channel protection.'],
    0x1AB: ['TPM_RC_CHANNEL_KEY', 'Secure channel was not established with required requester or TPM key.'],
    # Warnings
