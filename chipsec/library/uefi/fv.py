...
EFI_FV_FILETYPE_MICROCODE = 0x10
EFI_FV_FILETYPE_DIAGNOSTIC = 0x11
EFI_FV_FILETYPE_RAMBACK = 0x12
EFI_FV_FILETYPE_STANDALONE_MM_DRIVER = 0x13
EFI_FV_FILETYPE_MM_DEPENDENCY = 0x14
EFI_FV_FILETYPE_OPAL_ATTESTATION = 0x15
EFI_FV_FILETYPE_OTHER = 0x16
...
FILE_TYPE_NAMES = {
    ...
    0x11: 'FV_DIAGNOSTIC',
    0x12: 'FV_RAMBACK',
    0x13: 'FV_STANDALONE_MM_DRIVER',
    0x14: 'FV_MM_DEPENDENCY',
    0x15: 'FV_OPAL_ATTESTATION',
    0x16: 'FV_OTHER',
    0xF0: 'FV_FFS_PAD'
}
...
EFI_SECTION_PE32_PLUS = 0x1A
EFI_SECTION_PEI_DEPEX = 0x1B
EFI_SECTION_MM_DEPEX = 0x1C
EFI_SECTION_DISPOSABLE = 0x1D
EFI_SECTION_SMM_DEPEX = 0x1E
EFI_SECTION_EXTENDED_SIZE = 0x1F
...
SECTION_NAMES = {
    ...
    0x1D: 'S_DISPOSABLE',
    0x1E: 'S_SMM_DEPEX',
    0x1F: 'S_EXTENDED_SIZE'
}

EFI_SECTIONS_EXE = [EFI_SECTION_PE32, EFI_SECTION_PE32_PLUS, EFI_SECTION_TE, EFI_SECTION_PIC, EFI_SECTION_COMPATIBILITY16]
...
# Guided section authentication constants (PI 1.9 specification)
EFI_GUIDED_SECTION_PROCESSING_REQUIRED = 0x01
EFI_GUIDED_SECTION_AUTH_STATUS_VALID = 0x02

# Authentication status bit definitions (PI 1.9 specification)
...
# Standard compression types from PI specification
EFI_NOT_COMPRESSED = 0x00
EFI_STANDARD_COMPRESSION = 0x01
EFI_CERT_TYPE_RSA_2048_SHA256_GUID_size = struct.calcsize("16s256s256s")
EFI_CERT_TYPE_RSA_2048_SHA1_GUID = UUID("67F8444F-8743-48F1-A328-1EAAB8736080")
EFI_CERT_TYPE_PKCS7_GUID = UUID("4AAFD29D-68DF-49EE-8AA9-347D375665A7")
EFI_CERT_TYPE_X509_GUID = UUID("A5C059A1-94E4-4AA7-87B5-AB155C2BF072")
EFI_CERT_TYPE_SHA1_GUID = UUID("826CA512-CF10-4AC9-B187-BE01496631BD")
EFI_CERT_TYPE_SHA224_GUID = UUID("0B6E5233-A65C-44C9-9407-D9AB83BFC8BD")
EFI_CERT_TYPE_SHA256_GUID = UUID("C1C41626-504C-4092-ACA9-41F936934328")
EFI_CERT_TYPE_SHA384_GUID = UUID("FF3E5307-9FD0-48C9-85F1-8AD56C701E01")
EFI_CERT_TYPE_SHA512_GUID = UUID("093E0FAE-A6C4-4F50-9F1B-D41E2B89C19A")
EFI_CERT_TYPE_X509_SHA256_GUID = UUID("3BD2A492-96C0-4079-B420-FCF98EF103ED")
EFI_CERT_TYPE_X509_SHA384_GUID = UUID("7076876E-80C2-4EE6-AAD2-28B349A6865B")
EFI_CERT_TYPE_X509_SHA512_GUID = UUID("446DBF63-2502-4CDA-BCFA-2465D2B0FE9D")
EFI_CERT_TYPE_EXTERNAL_MANAGEMENT_GUID = UUID("452E8CEA-9574-4220-A928-07E9AB42F643")
...
# Enhanced Firmware Volume GUIDs for UEFI 2.10+
EFI_MEMORY_MAPPED_IO_ACCESS_GUID = UUID("8F644FA9-E850-4DB1-9CE2-0B44698E8DA4")
EFI_DELAYED_DISPATCH_GUID = UUID("3192FC92-1F33-4C06-81C9-C4B4BC84B9BB")
EFI_SMM_VARIABLE_WRITE_GUID = UUID("93BA1826-F4C4-4F19-87F1-4AC2DC7E8BC8")
EFI_VARIABLE_AUTHENTICATION_3_GUID = UUID("AAF32C78-947B-439A-A180-2E144EC37792")
EFI_CAPSULE_REPORT_GUID = UUID("39B68C46-F7FB-441B-B6EC-16B0F69821F3")
EFI_MEMORY_RANGE_CAPSULE_GUID = UUID("DE9F0EC1-F9FD-4F13-A4F6-3F14AD990365")
...
BROTLI_CUSTOM_DECOMPRESS_GUID = UUID("3D532050-5CDA-4FD0-879E-0F7F630D5AFB")
GZIP_CUSTOM_DECOMPRESS_GUID = UUID("CE3233F5-2CD6-4D87-9152-4A238BB45F07")
ZLIB_CUSTOM_DECOMPRESS_GUID = UUID("F4CCBFB7-F6E0-4F20-8805-203DA0938C04")
ZSTD_CUSTOM_DECOMPRESS_GUID = UUID("5CA4ED0B-D913-4AC8-948B-F4EC2F3E2F52")
LZ4_CUSTOM_DECOMPRESS_GUID = UUID("334F9D17-CA1F-4B97-8C71-6C8C8B06A2F0")
EFI_GUIDED_SECTION_ZLIB_AMD1 = UUID("A1B2C3D4-1111-2222-3333-444455556666")
EFI_GUIDED_SECTION_ZLIB_AMD2 = UUID("B1C2D3E4-7777-8888-9999-AAAABBBBCCCC")


# Additional vendor-specific compression GUIDs
...
# Standard UEFI/PI specification GUIDs (UEFI 2.11 and PI 1.9 compliance)
EFI_DECOMPRESS_PROTOCOL_GUID = UUID("D8117CFE-94A6-11D4-9A3A-0090273FC14D")
EFI_FIRMWARE_CONTENTS_SIGNED_GUID = UUID("0F9D89E8-9259-4F76-A5AF-0C89E34023DF")

# Standard compression section GUIDs from PI specification
EFI_STANDARD_COMPRESSION_GUID = UUID("DFEAC1E1-5D2F-4F59-A66D-8A7EE10A8D35")  # Custom GUID for standard compression sections
