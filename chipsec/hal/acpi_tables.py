...
class EINJ (ACPI_TABLE):
    ...
    def parseAddress(self, table_content):
        ...
        Address Space ID                            : 0x{:02X} - {}
        Register Bit Width                          : 0x{:02X}
        Register Bit Offset                         : 0x{:02X}
        Access Size                                 : 0x{:02X} - {}
        Address                                     : 0x{:016X}""".format( addrSpaceID, addrSpaceID_str, regBitWidth , regBitOffset, accessSize, accessSize_str, addr  )
