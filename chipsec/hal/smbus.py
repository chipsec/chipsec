...
class SMBus(hal_base.HALBase):
    ...
    def __init__(self, cs):
        ...
        self.cs.set_scope({
            ...
            "SMBUS_VID": "8086.SMBUS",
            "SMBUS_DID": "8086.SMBUS",
            "SMBUS_HST_STS": "8086.SMBUS",
            "SMBUS_HST_CMD": "8086.SMBUS",
            "SMBUS_HST_SLVA": "8086.SMBUS",
            "SMBUS_HST_CNT": "8086.SMBUS",
            "SMBUS_HST_D0": "8086.SMBUS",
            "SMBUS_HST_D1": "8086.SMBUS"
        })

    def get_SMBus_Base_Address(self):
        if self.cs.iobar.is_IO_BAR_defined('SMBUS_BASE'):
            (sba_base, sba_size) = self.cs.iobar.get_IO_BAR_base_address('SMBUS_BASE')
            return sba_base
        else:
    ...
    def is_SMBus_supported(self):
        did = self.cs.read_register('SMBUS_DID')
        vid = self.cs.read_register('SMBUS_VID')
