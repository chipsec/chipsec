...
from ctypes import pythonapi, py_object, create_string_buffer, POINTER, c_uint32
from ctypes import c_wchar_p, c_void_p, c_char, WinError, addressof, sizeof
...
###############################################################################################
    ...
    def _get_handle_for_pid(self, pid=0, ro=True):
        if pid == 0:
            ...
            try:
                ...
                self.logger.log("unable to open a process handle")
                raise ValueError(e)
        return pHandle
    ...
    def set_affinity(self, value):
        ...
        try:
            ...
            self.logger.log("unable to set process affinity")
            raise ValueError(e)
        return current
    ...
    def get_affinity(self):
        ...
        try:
            ...
            self.logger.log("unable to get the running cpu")
            raise ValueError(e)
