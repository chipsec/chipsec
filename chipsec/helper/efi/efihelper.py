...
###############################################################################################
    ...
    def load_ucode_update( self, cpu_thread_id, ucode_update_buf ):
        if logger().DEBUG: logger().log_error( "[efi] load_ucode_update is not supported yet" )
        return 0
    ...
    def get_ACPI_SDT( self ):
        if logger().DEBUG: logger().log_error( "[efi] ACPI is not supported yet" )
        return 0
    ...
    def msgbus_send_read_message( self, mcr, mcrx ):
        if logger().DEBUG: logger().log_error( "[efi] Message Bus is not supported yet" )
        return None
    ...
    def set_affinity( self, value ):
        if logger().DEBUG: logger().log_error( '[efi] API set_affinity() is not supported' )
        return 0
