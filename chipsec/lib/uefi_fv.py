...
SECTION_NAMES = {0x00: 'S_ALL', 0x01: 'S_COMPRESSION', 0x02: 'S_GUID_DEFINED', 0x10: 'S_PE32',
                 0x11: 'S_PIC', 0x12: 'S_TE', 0x13: 'S_DXE_DEPEX', 0x14: 'S_VERSION',
                 0x15: 'S_USER_INTERFACE', 0x16: 'S_COMPATIBILITY16', 0x17: 'S_FV_IMAGE',
                 0x18: 'S_FREEFORM_SUBTYPE_GUID', 0x19: 'S_RAW', 0x1B: 'S_PEI_DEPEX', 0x1C: 'S_MM_DEPEX'}
...
def NextFwVolume(buffer, off=0):
    ...
    while ((fof + vf_header_size) < size):
        ...
        if fof == -1 or size - fof < vf_header_size:
            ...
            continue
        fof = fof - 0x28
        ZeroVector, FileSystemGuid0, FvLength, Signature, Attributes, HeaderLength, Checksum, ExtHeaderOffset,    \
...
def GetFvHeader(buffer, off=0):
    ...
    _, FileSystemGuid0, FvLength, _, Attributes, HeaderLength, Checksum, ExtHeaderOffset, Reserved, Revision = struct.unpack(EFI_FIRMWARE_VOLUME_HEADER, buffer[off:off + struct.calcsize(EFI_FIRMWARE_VOLUME_HEADER)])
