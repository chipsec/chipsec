...
class TestInterruptsUtilcmd(unittest.TestCase):
    def test_count(self) -> None:
        ...
        retval = setup_run_destroy_util(init_replay_file, "interrupts", "count", util_replay_file=interrupts_dump_replay_file)
    ...
    def test_send(self) -> None:
        ...
        retval = setup_run_destroy_util(init_replay_file, "interrupts", "send 0x0 0xDE 0x0", util_replay_file=interrupts_dump_replay_file)
        self.assertEqual(retval, ExitCode.OK)
