...
from chipsec.testcase import TestCase, ExitCode
...
class ChipsecMain:
    ...
    def parse_args(self):
        ...
        adv_options.add_argument('-p', '--platform', dest='_platform', help='explicitly specify platform code', type=str.upper)
        adv_options.add_argument('--pch', dest='_pch', help='explicitly specify PCH code', type=str.upper)
    ...
    def main(self):
        ...
        if self._load_config:
            try:
                self._cs.init(self._platform, self._pch, True, self._driver_exists, self._to_file, self._from_file)
